...
public class MsgController extends BaseController {
    ...
    public Object msgReadDetele(@RequestParam("id") String id) {
		return BizConnecter.getBizData("805141", JsonUtils.string2Json("id", id),
	            Object.class);
    }
    ...
    @ResponseBody
    public Object msgReadPage(@RequestParam(value = "smsCode", required = false) String smsCode,
    ...
    @ResponseBody
    public Object msgReadList(@RequestParam(value = "smsCode", required = false) String smsCode,
    		@RequestParam(value = "status", required = false) String status,
    		@RequestParam(value = "dateStart", required = false) String dateStart,
    		@RequestParam(value = "dateEnd", required = false) String dateEnd) {
